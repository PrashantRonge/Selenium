...
public class TATA_AIG_DataProviderClass {
  @Test(dataProvider = "carInsRegression",dataProviderClass = TATA_AIG_DataProvider.class)
  public void f(String BRAND , String CAR ) throws InterruptedException 
  {
	  ...
	  Actions act = new Actions(driver);
		 ...
		 WebElement varient = driver.findElement(By.xpath("(//div[@class='select-field__input-container css-yw3jad'])[3]"));
		 act.click(varient).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ENTER).build().perform();
		 Thread.sleep(500);
...
//	    WebElement brand = driver.findElement(By.xpath("(//div[@class='select-field__input-container css-yw3jad'])[1]"));
//	    act.click(brand).sendKeys(Keys.ARROW_DOWN).perform();
//		Thread.sleep(1000);
...
//		
//		WebElement car = driver.findElement(By.xpath("(//div[@class='select-field__input-container css-yw3jad'])[2]"));
//		act.click(car).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ENTER).build().perform();
//		Thread.sleep(1000);
//	    
//	    WebElement varient = driver.findElement(By.xpath("(//div[@class='select-field__input-container css-yw3jad'])[3]"));
//		act.click(varient).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ENTER).build().perform();
